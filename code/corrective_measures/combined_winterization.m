...
weatherization_mw_ng = [5000, 1000, 1500, 1500, 3500, 4000, 1500, 2500];
weatherization_mw_wind = [1000, 2000, 500, 500, 000, 00, 00, 00];
weatherization_mw_coal = [0, 0, 0, 000, 2500, 500, 000, 1500];
